...
public class CityRaidersItemListItemListItemActivity extends AppCompatActivity {
        ...
        handler = new Handler(new Handler.Callback() {
            ...
            public boolean handleMessage(Message msg) {
                if (msg.what == 200){
                    ...
                    dialog.dismiss();
                    exListView.setAdapter(new MyAdapter(CityRaidersItemListItemListItemActivity.this,childrenLists));
...
//            //Grid
            ...
            if (photosList != null && photosList.size() != 0){
                ...
                for (CityRaiders.PagesBean.ChildrenBean.SectionsBean.PhotosBean photosBean : photosList){
                    ...
                    if ( h > 300){
                        w = w/ (h  / 300 ) ;
                        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(w > 400?400 : w, 300);
